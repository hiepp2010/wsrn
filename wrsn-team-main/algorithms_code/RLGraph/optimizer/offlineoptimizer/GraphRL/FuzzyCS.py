...
class FuzzyCS:
    ...
    def initialize(self):
        ...
        U_2 = FuzzySet(function=Trapezoidal_MF(a=0.15, b=0.45, c=0.65, d=0.85), term='moderate')
        U_3 = FuzzySet(function=Trapezoidal_MF(a=0.65, b=0.85, c=1, d=1), term='high')
        LV1 = LinguisticVariable([U_1, U_2, U_3], concept='U', universe_of_discourse=[0, 1])
        FS.add_linguistic_variable('U', LV1)

        ESR_1 = FuzzySet(function=Trapezoidal_MF(a=0, b=0, c=0.15, d=0.2), term='low')
        ESR_2 = FuzzySet(function=Trapezoidal_MF(a=0.15, b=0.2, c=0.35, d=0.5), term='moderate')
        ESR_3 = FuzzySet(function=Trapezoidal_MF(a=0.35, b=0.5, c=1, d=1), term='high')
        LV2 = LinguisticVariable([ESR_1, ESR_2, ESR_3], concept='ESR', universe_of_discourse=[0, 1])
        FS.add_linguistic_variable('ESR', LV2)

        E_1 = FuzzySet(function=Trapezoidal_MF(a=0, b=0, c=0.15, d=0.45), term='low')
        E_2 = FuzzySet(function=Trapezoidal_MF(a=0.15, b=0.45, c=0.65, d=0.85), term='moderate')
        E_3 = FuzzySet(function=Trapezoidal_MF(a=0.65, b=0.85, c=1, d=1), term='high')
        ...
        SAFE_5 = FuzzySet(function=Trapezoidal_MF(a=0.65, b=0.75, c=0.8, d=9), term='veryhigh')
        ...
        R3 = 'IF (U IS low) AND (ESR IS low) AND (E IS high) THEN (SAFE IS verylow)'
        R4 = 'IF (U IS low) AND (ESR IS moderate) AND (E IS low) THEN (SAFE IS moderate)'
        R5 = 'IF (U IS low) AND (ESR IS moderate) AND (E IS moderate) THEN (SAFE IS high)'
        R6 = 'IF (U IS low) AND (ESR IS moderate) AND (E IS high) THEN (SAFE IS high)'
        ...
        R13 = 'IF (U IS moderate) AND (ESR IS moderate) AND (E IS low) THEN (SAFE IS high)'
        R14 = 'IF (U IS moderate) AND (ESR IS moderate) AND (E IS moderate) THEN (SAFE IS high)'
        R15 = 'IF (U IS moderate) AND (ESR IS moderate) AND (E IS high) THEN (SAFE IS veryhigh)'
        R16 = 'IF (U IS moderate) AND (ESR IS high) AND (E IS low) THEN (SAFE IS veryhigh)'
        R17 = 'IF (U IS moderate) AND (ESR IS high) AND (E IS moderate) THEN (SAFE IS veryhigh)'
        R18 = 'IF (U IS moderate) AND (ESR IS high) AND (E IS high) THEN (SAFE IS exhigh)'

        R19 = 'IF (U IS high) AND (ESR IS low) AND (E IS low) THEN (SAFE IS verylow)'
        ...
        R22 = 'IF (U IS high) AND (ESR IS moderate) AND (E IS low) THEN (SAFE IS high)'
        R23 = 'IF (U IS high) AND (ESR IS moderate) AND (E IS moderate) THEN (SAFE IS veryhigh)'
