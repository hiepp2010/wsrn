...
//    For experiment 20/08/2020
    ...
    public static final int E_MC_DEFAULT = 216000;
...
//    public static final int[] Us = {5, 10, 15, 20, 25};
    public static final double[] Us = {1.33, 2.66, 4, 5.33, 6.66};
...
//public static final double[] Ps = {1, 1.5};
 public static final double[] Ps = {0.25*1.5, 1.5*0.5 , 1.5*1, 1.5*2};
}
